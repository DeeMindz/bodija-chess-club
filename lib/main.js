...
function openPlayerDetail(playerId) {
    ...
    if (content) content.innerHTML = `
            ...
            : `<span class="perf-icon ${perf.class}">${perf.icon}</span>`}
                ...
                <!-- Medals section — populated async below -->
                <div id="playerMedalsSection" style="margin-top:20px;">
                    <div style="display:flex;align-items:center;gap:8px;margin-bottom:12px;">
                        <h4 style="margin:0;">Tournament Medals</h4>
                    </div>
                    <div id="playerMedalsList" style="display:flex;align-items:center;gap:6px;flex-wrap:wrap;">
                        <span style="font-size:13px;color:var(--text-secondary);opacity:0.6;">Loading medals...</span>
                    </div>
                </div>
        `;
