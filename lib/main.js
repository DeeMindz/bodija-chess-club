...
async function silentRefresh() {
    try {
        ...
        const [playersResp, gamesResp, tournamentsResp] = await Promise.all([
            ...
            fetch(base + 'games?select=id,date,white_player_id,black_player_id,white_player_name,black_player_name,result,white_rating_change,black_rating_change,white_rating_before,black_rating_before,tournament_name,round_number,created_at&order=created_at.desc&limit=500', { headers }),
