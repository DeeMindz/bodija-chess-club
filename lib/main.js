...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    console.log('[BCC] Players:', players.length, playersResult.error?.message)
    console.log('[BCC] Games:', games.length, gamesResult.error?.message)
    console.log('[BCC] Tournaments:', (tournamentsResult.data || []).length, tournamentsResult.error?.message)
    console.log('[BCC] Games error:', gamesResult.error)
    console.log('[BCC] Tournaments error:', tournamentsResult.error)
