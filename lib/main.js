...
window.manualRefresh = async function() {
    ...
    try {
        ...
        if (activeSection === 'dashboard') { renderDashboard(); renderLeaderboard(); }
        else if (activeSection === 'leaderboard') renderLeaderboard();
        else if (activeSection === 'players') renderPlayers();
        else if (activeSection === 'tournaments') renderTournaments();
