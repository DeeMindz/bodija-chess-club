...
function updateAdminUI() {
    ...
    if (notificationBtn) {
        notificationBtn.style.display = isAdmin ? 'flex' : 'none';
    }
...
async function checkRLSStatus() {
    try {
        ...
        console.warn('?? Supabase connection issue. Ensure RLS is enabled on your Supabase dashboard.');
    }
}
...
function setupNavigation() {
    ...
    // Get saved section - default to dashboard
    const savedSection = sessionStorage.getItem('bcc_active_section') || 'dashboard';
    ...
    content.innerHTML = `
            <div style = "padding: 20px 0;" >
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                        ...
                        <div style="background: var(--bg-tertiary); padding: 12px; border-radius: 8px; border: 1px solid var(--border-color);">
                            <div style="font-size: 12px; color: var(--text-secondary);">White Δ</div>
                        ...
                        <div style="background: var(--bg-tertiary); padding: 12px; border-radius: 8px; border: 1px solid var(--border-color);">
                            <div style="font-size: 12px; color: var(--text-secondary);">Black Δ</div>
...
function renderTournaments() {
    ...
    // Header Section - Only show for admin
    if (isAdmin) {
        html += `
            <div class="tournament-header-actions admin-only" style="margin-bottom: 30px;">
            ...
            <div class="standings-container">
                <div class="standings-table">
                    <div class="standings-header">
                        ...
                        <span class="col-change">Rating Δ</span>
                    </div>
