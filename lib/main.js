...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        playersResult = await Promise.race([
            ...
            new Promise((_, r) => setTimeout(() => r(new Error('Players timeout')), 15000))
        ]);
        ...
        gamesResult = await Promise.race([
            ...
            new Promise((_, r) => setTimeout(() => r(new Error('Games timeout')), 15000))
        ]);
        ...
        tournamentsResult = await Promise.race([
            ...
            new Promise((_, r) => setTimeout(() => r(new Error('Tournaments timeout')), 15000))
        ]);
...
function openGameDetail(gameId) {
    ...
    const whiteRating = whitePlayer?.rating || 'N/A';
    const blackRating = blackPlayer?.rating || 'N/A';
