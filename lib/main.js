...
async function confirmRoundSubmit() {
    ...
    try {
        ...
        if (isLastRound) {
            ...
            // Close tournament detail modal immediately so it doesn't flash
            if (modal) modal.classList.remove('active');
            ...
            // Navigate to tournaments section first (while modal is still showing)
            ...
            // Refresh data so completed tournament is ready
