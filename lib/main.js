...
function generateRoundLocally() {
    ...
    if (format === 'swiss') {
        ...
        console.warn('Unknown format for pairing generation:', currentTournament.format);
    }
...
function generateRoundRobinPairings(players, round) {
    ...
    // Check if double round robin using format string
    const isDouble = isDoubleRR(currentTournament.format) || currentTournament.isDoubleRoundRobin;
